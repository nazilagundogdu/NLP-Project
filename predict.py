...
# project imports
from Untitled import substring, instances_test, load_vocabulary, index_instances, generate_batches
...
def predict(model: models.Model,
    ...
    if save_to_file:
        ...
        with open(save_to_file, "w") as file:
            for predicted_label_array in all_predicted_labels:
                for predicted_sequence in predicted_label_array:
                    for predicted_label in predicted_sequence:
...
if __name__ == '__main__':
    ...
    instances = index_instances(instances_test, vocab_token_to_id)
