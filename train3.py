...
# project imports
from data import substring, instances, save_vocabulary, build_vocabulary, \
                 load_vocabulary, index_instances, generate_batches, load_glove_embeddings
from main import MainClassifier
...
def train(model: models.Model,
    ...
    tensorboard_writer = tf.compat.v1.summary.FileWriter(tensorboard_logs_path)
...
#    base_parser.add_argument('validation_data_file_path', type=str, help='validation data file path')
    ...
    if args.load_serialization_dir:
        ...
        vocab_token_to_id, vocab_id_to_token = build_vocabulary(instances, VOCAB_SIZE,
                                                                glove_common_words)
